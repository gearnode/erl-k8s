...
-export_type([definition_id/0,
              ...
              networking_v1_network_policy_status/0,
              ...
              storage_v1_csi_storage_capacity/0,
              storage_v1_csi_storage_capacity_list/0,
...
-type networking_v1_network_policy() ::
        #{status => k8s_model:networking_v1_network_policy_status(),
...
%% NetworkPolicy.
-type networking_v1_network_policy_status() ::
        #{conditions => [k8s_model:apimachinery_apis_meta_v1_condition()]}.
...
-type storage_v1_csi_storage_capacity() ::
        #{storageClassName := binary(),
...
%% objects.
-type storage_v1_csi_storage_capacity_list() ::
        #{metadata => k8s_model:apimachinery_apis_meta_v1_list_meta(),
          kind => binary(),
          items := [k8s_model:storage_v1_csi_storage_capacity()],
          apiVersion => binary()}.
