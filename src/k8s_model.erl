...
-export_type([definition_id/0,
              ...
              networking_v1beta1_ingress_class_parameters_reference/0,
...
%% IngressClassParametersReference identifies an API object. This
%% can be used to specify a cluster or namespace-scoped resource.
-type networking_v1beta1_ingress_class_parameters_reference() ::
        #{scope => binary(),
          namespace => binary(),
          name := binary(),
          kind := binary(),
...
-type networking_v1beta1_ingress_class_spec() ::
        #{parameters => k8s_model:networking_v1beta1_ingress_class_parameters_reference(),
          controller => binary()}.
