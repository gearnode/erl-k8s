...
-export_type([definition_id/0,
              ...
              apiextensions_v1_validation_rule/0,
              ...
              apimachinery_apis_meta_v1_delete_options_v2/0,
              apimachinery_apis_meta_v1_duration/0,
              ...
              apimachinery_apis_meta_v1_managed_fields_entry_v2/0,
              apimachinery_apis_meta_v1_micro_time/0,
              apimachinery_apis_meta_v1_object_meta/0,
              apimachinery_apis_meta_v1_object_meta_v2/0,
              apimachinery_apis_meta_v1_owner_reference/0,
              apimachinery_apis_meta_v1_owner_reference_v2/0,
              apimachinery_apis_meta_v1_owner_reference_v3/0,
              ...
              apimachinery_apis_meta_v1_status_details_v2/0,
              apimachinery_apis_meta_v1_status_v2/0,
              ...
              apps_v1_stateful_set_persistent_volume_claim_retention_policy/0,
              ...
              authentication_v1_token_request_status/0,
              ...
              autoscaling_v2_container_resource_metric_source/0,
              autoscaling_v2_container_resource_metric_status/0,
              autoscaling_v2_cross_version_object_reference/0,
              autoscaling_v2_external_metric_source/0,
              autoscaling_v2_external_metric_status/0,
              autoscaling_v2_horizontal_pod_autoscaler/0,
              autoscaling_v2_horizontal_pod_autoscaler_behavior/0,
              autoscaling_v2_horizontal_pod_autoscaler_condition/0,
              autoscaling_v2_horizontal_pod_autoscaler_list/0,
              autoscaling_v2_horizontal_pod_autoscaler_spec/0,
              autoscaling_v2_horizontal_pod_autoscaler_status/0,
              autoscaling_v2_hpa_scaling_policy/0,
              autoscaling_v2_hpa_scaling_rules/0,
              autoscaling_v2_metric_identifier/0,
              autoscaling_v2_metric_spec/0,
              autoscaling_v2_metric_status/0,
              autoscaling_v2_metric_target/0,
              autoscaling_v2_metric_value_status/0,
              autoscaling_v2_object_metric_source/0,
              autoscaling_v2_object_metric_status/0,
              autoscaling_v2_pods_metric_source/0,
              autoscaling_v2_pods_metric_status/0,
              autoscaling_v2_resource_metric_source/0,
              autoscaling_v2_resource_metric_status/0,
              ...
              batch_v1_cron_job/0,
              batch_v1_cron_job_list/0,
              batch_v1_cron_job_spec/0,
              batch_v1_cron_job_status/0,
              batch_v1_job/0,
              batch_v1_job_condition/0,
              batch_v1_job_list/0,
              batch_v1_job_spec/0,
              batch_v1_job_status/0,
              batch_v1_job_template_spec/0,
              batch_v1_uncounted_terminated_pods/0,
              ...
              discovery_v1_endpoint/0,
              discovery_v1_endpoint_conditions/0,
              discovery_v1_endpoint_hints/0,
              discovery_v1_endpoint_port/0,
              discovery_v1_endpoint_slice/0,
              discovery_v1_endpoint_slice_list/0,
              discovery_v1_for_zone/0,
              discovery_v1beta1_endpoint/0,
              discovery_v1beta1_endpoint_conditions/0,
              discovery_v1beta1_endpoint_hints/0,
              discovery_v1beta1_endpoint_port/0,
              discovery_v1beta1_endpoint_slice/0,
              discovery_v1beta1_endpoint_slice_list/0,
              discovery_v1beta1_for_zone/0,
              events_v1_event/0,
              ...
              flowcontrol_v1beta2_flow_distinguisher_method/0,
              flowcontrol_v1beta2_flow_schema/0,
              flowcontrol_v1beta2_flow_schema_condition/0,
              flowcontrol_v1beta2_flow_schema_list/0,
              flowcontrol_v1beta2_flow_schema_spec/0,
              flowcontrol_v1beta2_flow_schema_status/0,
              flowcontrol_v1beta2_group_subject/0,
              flowcontrol_v1beta2_limit_response/0,
              flowcontrol_v1beta2_limited_priority_level_configuration/0,
              flowcontrol_v1beta2_non_resource_policy_rule/0,
              flowcontrol_v1beta2_policy_rules_with_subjects/0,
              flowcontrol_v1beta2_priority_level_configuration/0,
              flowcontrol_v1beta2_priority_level_configuration_condition/0,
              flowcontrol_v1beta2_priority_level_configuration_list/0,
              flowcontrol_v1beta2_priority_level_configuration_reference/0,
              flowcontrol_v1beta2_priority_level_configuration_spec/0,
              flowcontrol_v1beta2_priority_level_configuration_status/0,
              flowcontrol_v1beta2_queuing_configuration/0,
              flowcontrol_v1beta2_resource_policy_rule/0,
              flowcontrol_v1beta2_service_account_subject/0,
              flowcontrol_v1beta2_subject/0,
              flowcontrol_v1beta2_user_subject/0,
              io_cattle_helm_v1_helm_chart/0,
              io_cattle_helm_v1_helm_chart_config/0,
              io_cattle_helm_v1_helm_chart_config_list/0,
              io_cattle_helm_v1_helm_chart_list/0,
              io_cattle_k3s_v1_addon/0,
              io_cattle_k3s_v1_addon_list/0,
              io_k8s_metrics_pkg_apis_metrics_v1beta1_container_metrics/0,
              io_k8s_metrics_pkg_apis_metrics_v1beta1_node_metrics/0,
              io_k8s_metrics_pkg_apis_metrics_v1beta1_node_metrics_list/0,
              io_k8s_metrics_pkg_apis_metrics_v1beta1_pod_metrics/0,
              io_k8s_metrics_pkg_apis_metrics_v1beta1_pod_metrics_list/0,
              ...
              networking_v1_ingress_class_parameters_reference/0,
              ...
              policy_v1_eviction/0,
              policy_v1_pod_disruption_budget/0,
              policy_v1_pod_disruption_budget_list/0,
              policy_v1_pod_disruption_budget_spec/0,
              policy_v1_pod_disruption_budget_status/0,
              ...
              storage_v1beta1_csi_storage_capacity/0,
              storage_v1beta1_csi_storage_capacity_list/0,
              us_containo_traefik_v1alpha1_ingress_route/0,
              us_containo_traefik_v1alpha1_ingress_route_list/0,
              us_containo_traefik_v1alpha1_ingress_route_tcp/0,
              us_containo_traefik_v1alpha1_ingress_route_tcp_list/0,
              us_containo_traefik_v1alpha1_ingress_route_udp/0,
              us_containo_traefik_v1alpha1_ingress_route_udp_list/0,
              us_containo_traefik_v1alpha1_middleware/0,
              us_containo_traefik_v1alpha1_middleware_list/0,
              us_containo_traefik_v1alpha1_middleware_tcp/0,
              us_containo_traefik_v1alpha1_middleware_tcp_list/0,
              us_containo_traefik_v1alpha1_servers_transport/0,
              us_containo_traefik_v1alpha1_servers_transport_list/0,
              us_containo_traefik_v1alpha1_tls_option/0,
              us_containo_traefik_v1alpha1_tls_option_list/0,
              us_containo_traefik_v1alpha1_tls_store/0,
              us_containo_traefik_v1alpha1_tls_store_list/0,
              us_containo_traefik_v1alpha1_traefik_service/0,
              us_containo_traefik_v1alpha1_traefik_service_list/0]).
...
-type apiextensions_v1_json_schema_props() ::
        #{title => binary(),
          ...
          'x-kubernetes-validations' => [k8s_model:apiextensions_v1_validation_rule()]}.
...
%% expression language.
-type apiextensions_v1_validation_rule() ::
        #{rule := binary(),
          message => binary()}.
...
%%
%% DeleteOptions may be provided when deleting an API object.
-type apimachinery_apis_meta_v1_delete_options_v2() ::
        #{propagationPolicy => binary(),
          preconditions => k8s_model:apimachinery_apis_meta_v1_preconditions(),
          orphanDependents => boolean(),
          kind => binary(),
...
-type apimachinery_apis_meta_v1_duration() ::
        binary().
...
%% ManagedFieldsEntry is a workflow-id, a FieldSet and the group
%% version of the resource that the fieldset applies to.
-type apimachinery_apis_meta_v1_managed_fields_entry_v2() ::
        #{time => k8s_model:apimachinery_apis_meta_v1_time(),
          operation => binary(),
          manager => binary(),
          'fieldsV1' => k8s_model:apimachinery_apis_meta_v1_fields_v1(),
...
%% ObjectMeta is metadata that all persisted resources must have,
%% which includes all objects users must create.
-type apimachinery_apis_meta_v1_object_meta_v2() ::
        #{uid => binary(),
          selfLink => binary(),
          resourceVersion => binary(),
          ownerReferences => [k8s_model:apimachinery_apis_meta_v1_owner_reference_v2()],
          namespace => binary(),
          name => binary(),
          managedFields => [k8s_model:apimachinery_apis_meta_v1_managed_fields_entry()],
          labels => #{_ := binary()},
...
%% the dependent, or be cluster-scoped, so there is no namespace
%% field.
-type apimachinery_apis_meta_v1_owner_reference_v2() ::
        #{uid := binary(),
          name := binary(),
          kind := binary(),
          controller => boolean(),
...
%% the dependent, or be cluster-scoped, so there is no namespace
%% field.
-type apimachinery_apis_meta_v1_owner_reference_v3() ::
        #{uid := binary(),
          name := binary(),
          kind := binary(),
          controller => boolean(),
...
%% type of each attribute, and should assume that any attribute may
%% be empty, invalid, or under defined.
-type apimachinery_apis_meta_v1_status_details_v2() ::
        #{uid => binary(),
          retryAfterSeconds => integer(),
          name => binary(),
          kind => binary(),
...
%% Status is a return value for calls that don't return other
%% objects.
-type apimachinery_apis_meta_v1_status_v2() ::
        #{status => binary(),
          reason => binary(),
          metadata => k8s_model:apimachinery_apis_meta_v1_list_meta(),
          message => binary(),
          kind => binary(),
          details => k8s_model:apimachinery_apis_meta_v1_status_details_v2(),
          code => integer(),
          apiVersion => binary()}.
...
-type apps_v1_stateful_set_persistent_volume_claim_retention_policy() ::
        #{whenScaled => binary(),
          whenDeleted => binary()}.
...
-type apps_v1_stateful_set_spec() ::
        #{volumeClaimTemplates => [k8s_model:core_v1_persistent_volume_claim()],
          ...
          persistentVolumeClaimRetentionPolicy => k8s_model:apps_v1_stateful_set_persistent_volume_claim_retention_policy(),
          minReadySeconds => integer()}.
...
%% type should be set.
-type autoscaling_v2_container_resource_metric_source() ::
        #{target := k8s_model:autoscaling_v2_metric_target(),
          name := binary(),
          container := binary()}.
...
-type autoscaling_v2_container_resource_metric_status() ::
        #{name := binary(),
          current := k8s_model:autoscaling_v2_metric_value_status(),
          container := binary()}.
...
%% CrossVersionObjectReference contains enough information to let
%% you identify the referred resource.
-type autoscaling_v2_cross_version_object_reference() ::
        #{name := binary(),
          kind := binary(),
          apiVersion => binary()}.
...
-type autoscaling_v2_external_metric_source() ::
        #{target := k8s_model:autoscaling_v2_metric_target(),
          metric := k8s_model:autoscaling_v2_metric_identifier()}.
...
-type autoscaling_v2_external_metric_status() ::
        #{metric := k8s_model:autoscaling_v2_metric_identifier(),
          current := k8s_model:autoscaling_v2_metric_value_status()}.
...
%% specified.
-type autoscaling_v2_horizontal_pod_autoscaler() ::
        #{status => k8s_model:autoscaling_v2_horizontal_pod_autoscaler_status(),
          spec => k8s_model:autoscaling_v2_horizontal_pod_autoscaler_spec(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta(),
          kind => binary(),
          apiVersion => binary()}.
...
-type autoscaling_v2_horizontal_pod_autoscaler_behavior() ::
        #{scaleUp => k8s_model:autoscaling_v2_hpa_scaling_rules(),
          scaleDown => k8s_model:autoscaling_v2_hpa_scaling_rules()}.
...
-type autoscaling_v2_horizontal_pod_autoscaler_condition() ::
        #{type := binary(),
          status := binary(),
          reason => binary(),
          message => binary(),
...
%% autoscaler objects.
-type autoscaling_v2_horizontal_pod_autoscaler_list() ::
        #{metadata => k8s_model:apimachinery_apis_meta_v1_list_meta(),
          kind => binary(),
          items := [k8s_model:autoscaling_v2_horizontal_pod_autoscaler()],
          apiVersion => binary()}.
...
-type autoscaling_v2_horizontal_pod_autoscaler_spec() ::
        #{scaleTargetRef := k8s_model:autoscaling_v2_cross_version_object_reference(),
          minReplicas => integer(),
          metrics => [k8s_model:autoscaling_v2_metric_spec()],
          maxReplicas := integer(),
          behavior => k8s_model:autoscaling_v2_horizontal_pod_autoscaler_behavior()}.
...
-type autoscaling_v2_horizontal_pod_autoscaler_status() ::
        #{observedGeneration => integer(),
          lastScaleTime => k8s_model:apimachinery_apis_meta_v1_time(),
          desiredReplicas := integer(),
          currentReplicas => integer(),
          currentMetrics => [k8s_model:autoscaling_v2_metric_status()],
          conditions => [k8s_model:autoscaling_v2_horizontal_pod_autoscaler_condition()]}.
...
-type autoscaling_v2_hpa_scaling_policy() ::
        #{value := integer(),
          type := binary(),
...
-type autoscaling_v2_metric_spec() ::
        #{type := binary(),
          resource => k8s_model:autoscaling_v2_resource_metric_source(),
          pods => k8s_model:autoscaling_v2_pods_metric_source(),
          object => k8s_model:autoscaling_v2_object_metric_source(),
          external => k8s_model:autoscaling_v2_external_metric_source(),
          containerResource => k8s_model:autoscaling_v2_container_resource_metric_source()}.

%% io.k8s.api.autoscaling.v2.MetricStatus
%%
%% MetricStatus describes the last-read state of a single metric.
-type autoscaling_v2_metric_status() ::
        #{type := binary(),
          resource => k8s_model:autoscaling_v2_resource_metric_status(),
          pods => k8s_model:autoscaling_v2_pods_metric_status(),
          object => k8s_model:autoscaling_v2_object_metric_status(),
          external => k8s_model:autoscaling_v2_external_metric_status(),
          containerResource => k8s_model:autoscaling_v2_container_resource_metric_status()}.
...
-type autoscaling_v2_metric_target() ::
...
-type autoscaling_v2_metric_value_status() ::
        #{value => k8s_model:apimachinery_api_resource_quantity(),
          averageValue => k8s_model:apimachinery_api_resource_quantity(),
          averageUtilization => integer()}.
...
%% object).
-type autoscaling_v2_object_metric_source() ::
        #{target := k8s_model:autoscaling_v2_metric_target(),
          metric := k8s_model:autoscaling_v2_metric_identifier(),
          describedObject := k8s_model:autoscaling_v2_cross_version_object_reference()}.
...
%% an Ingress object).
-type autoscaling_v2_object_metric_status() ::
        #{metric := k8s_model:autoscaling_v2_metric_identifier(),
          describedObject := k8s_model:autoscaling_v2_cross_version_object_reference(),
          current := k8s_model:autoscaling_v2_metric_value_status()}.
...
-type autoscaling_v2_pods_metric_source() ::
        #{target := k8s_model:autoscaling_v2_metric_target(),
          metric := k8s_model:autoscaling_v2_metric_identifier()}.
...
-type autoscaling_v2_pods_metric_status() ::
        #{metric := k8s_model:autoscaling_v2_metric_identifier(),
          current := k8s_model:autoscaling_v2_metric_value_status()}.
...
%% normal per-pod metrics using the "pods" source. Only one "target"
%% type should be set.
-type autoscaling_v2_resource_metric_source() ::
        #{target := k8s_model:autoscaling_v2_metric_target(),
          name := binary()}.
...
-type autoscaling_v2_resource_metric_status() ::
        #{name := binary(),
          current := k8s_model:autoscaling_v2_metric_value_status()}.
...
-type batch_v1_cron_job() ::
        #{status => k8s_model:batch_v1_cron_job_status(),
          spec => k8s_model:batch_v1_cron_job_spec(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta(),
          kind => binary(),
          apiVersion => binary()}.
...
-type batch_v1_cron_job_list() ::
        #{metadata => k8s_model:apimachinery_apis_meta_v1_list_meta(),
          kind => binary(),
          items := [k8s_model:batch_v1_cron_job()],
          apiVersion => binary()}.
...
-type batch_v1_cron_job_spec() ::
        #{suspend => boolean(),
          successfulJobsHistoryLimit => integer(),
          startingDeadlineSeconds => integer(),
          schedule := binary(),
          jobTemplate := k8s_model:batch_v1_job_template_spec(),
...
-type batch_v1_cron_job_status() ::
        #{lastSuccessfulTime => k8s_model:apimachinery_apis_meta_v1_time(),
...
-type batch_v1_job_status() ::
        #{uncountedTerminatedPods => k8s_model:batch_v1_uncounted_terminated_pods(),
          succeeded => integer(),
...
%% from a template
-type batch_v1_job_template_spec() ::
        #{spec => k8s_model:batch_v1_job_spec(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta()}.
...
-type batch_v1_uncounted_terminated_pods() ::
        #{succeeded => [binary()],
          failed => [binary()]}.
...
-type core_v1_lifecycle() ::
        #{preStop => k8s_model:core_v1_lifecycle_handler(),
          postStart => k8s_model:core_v1_lifecycle_handler()}.
...
-type core_v1_lifecycle_handler() ::
...
-type core_v1_persistent_volume_claim_spec() ::
        #{volumeName => binary(),
          ...
          selector => k8s_model:apimachinery_apis_meta_v1_label_selector(),
          resources => k8s_model:core_v1_resource_requirements(),
          dataSourceRef => k8s_model:core_v1_typed_local_object_reference(),
...
-type core_v1_persistent_volume_claim_status() ::
        #{resizeStatus => binary(),
          ...
          capacity => #{_ := k8s_model:apimachinery_api_resource_quantity()},
          allocatedResources => #{_ := k8s_model:apimachinery_api_resource_quantity()},
          accessModes => [binary()]}.
...
-type core_v1_probe() ::
        #{timeoutSeconds => integer(),
          ...
          httpGet => k8s_model:core_v1_http_get_action(),
          grpc => k8s_model:core_v1_grpc_action(),
...
-type core_v1_service_spec() ::
        #{type => binary(),
          ...
          loadBalancerClass => binary(),
          ipFamilyPolicy => binary(),
          ipFamilies => [binary()],
          internalTrafficPolicy => binary(),
...
%% service.
-type discovery_v1_endpoint() ::
        #{zone => binary(),
          targetRef => k8s_model:core_v1_object_reference(),
          nodeName => binary(),
          hostname => binary(),
          hints => k8s_model:discovery_v1_endpoint_hints(),
          deprecatedTopology => #{_ := binary()},
          conditions => k8s_model:discovery_v1_endpoint_conditions(),
          addresses := [binary()]}.
...
%% endpoint.
-type discovery_v1_endpoint_conditions() ::
        #{terminating => boolean(),
          serving => boolean(),
          ready => boolean()}.
...
%% consumed.
-type discovery_v1_endpoint_hints() ::
        #{forZones => [k8s_model:discovery_v1_for_zone()]}.

%% io.k8s.api.discovery.v1.EndpointPort
%%
%% EndpointPort represents a Port used by an EndpointSlice
-type discovery_v1_endpoint_port() ::
        #{protocol => binary(),
          port => integer(),
          name => binary(),
          appProtocol => binary()}.
...
-type discovery_v1_endpoint_slice() ::
        #{ports => [k8s_model:discovery_v1_endpoint_port()],
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta(),
          kind => binary(),
          endpoints := [k8s_model:discovery_v1_endpoint()],
          apiVersion => binary(),
          addressType := binary()}.
...
-type discovery_v1_endpoint_slice_list() ::
        #{metadata => k8s_model:apimachinery_apis_meta_v1_list_meta(),
          kind => binary(),
          items := [k8s_model:discovery_v1_endpoint_slice()],
          apiVersion => binary()}.
...
-type discovery_v1beta1_endpoint() ::
        #{topology => #{_ := binary()},
          ...
          nodeName => binary(),
          hostname => binary(),
          hints => k8s_model:discovery_v1beta1_endpoint_hints(),
...
%% EndpointHints provides hints describing how an endpoint should be
%% consumed.
-type discovery_v1beta1_endpoint_hints() ::
        #{forZones => [k8s_model:discovery_v1beta1_for_zone()]}.
...
%% ForZone provides information about which zones should consume
%% this endpoint.
-type discovery_v1beta1_for_zone() ::
        #{name := binary()}.
...
%% FlowDistinguisherMethod specifies the method of a flow
%% distinguisher.
-type flowcontrol_v1beta2_flow_distinguisher_method() ::
        #{type := binary()}.
...
%% attributes and is identified by a pair of strings: the name of
%% the FlowSchema and a "flow distinguisher".
-type flowcontrol_v1beta2_flow_schema() ::
        #{status => k8s_model:flowcontrol_v1beta2_flow_schema_status(),
          spec => k8s_model:flowcontrol_v1beta2_flow_schema_spec(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta(),
          kind => binary(),
          apiVersion => binary()}.
...
%%
%% FlowSchemaCondition describes conditions for a FlowSchema.
-type flowcontrol_v1beta2_flow_schema_condition() ::
        #{type => binary(),
          status => binary(),
          reason => binary(),
          message => binary(),
...
%%
%% FlowSchemaList is a list of FlowSchema objects.
-type flowcontrol_v1beta2_flow_schema_list() ::
        #{metadata => k8s_model:apimachinery_apis_meta_v1_list_meta(),
          kind => binary(),
          items := [k8s_model:flowcontrol_v1beta2_flow_schema()],
          apiVersion => binary()}.
...
%% FlowSchemaSpec describes how the FlowSchema's specification looks
%% like.
-type flowcontrol_v1beta2_flow_schema_spec() ::
        #{rules => [k8s_model:flowcontrol_v1beta2_policy_rules_with_subjects()],
          priorityLevelConfiguration := k8s_model:flowcontrol_v1beta2_priority_level_configuration_reference(),
          matchingPrecedence => integer(),
          distinguisherMethod => k8s_model:flowcontrol_v1beta2_flow_distinguisher_method()}.

%% io.k8s.api.flowcontrol.v1beta2.FlowSchemaStatus
%%
%% FlowSchemaStatus represents the current state of a FlowSchema.
-type flowcontrol_v1beta2_flow_schema_status() ::
        #{conditions => [k8s_model:flowcontrol_v1beta2_flow_schema_condition()]}.

%% io.k8s.api.flowcontrol.v1beta2.GroupSubject
%%
%% GroupSubject holds detailed information for group-kind subject.
-type flowcontrol_v1beta2_group_subject() ::
        #{name := binary()}.
...
%% LimitResponse defines how to handle requests that can not be
%% executed right now.
-type flowcontrol_v1beta2_limit_response() ::
        #{type := binary(),
          queuing => k8s_model:flowcontrol_v1beta2_queuing_configuration()}.
...
%% * How are requests for this priority level limited?
%% * What should be done with requests that exceed the limit?
-type flowcontrol_v1beta2_limited_priority_level_configuration() ::
        #{limitResponse => k8s_model:flowcontrol_v1beta2_limit_response(),
          assuredConcurrencyShares => integer()}.
...
%% at least one member of verbs matches the request and (b) at least
%% one member of nonResourceURLs matches the request.
-type flowcontrol_v1beta2_non_resource_policy_rule() ::
        #{verbs := [binary()],
          nonResourceURLs := [binary()]}.
...
%% request and (b) at least one member of resourceRules or
%% nonResourceRules matches the request.
-type flowcontrol_v1beta2_policy_rules_with_subjects() ::
        #{subjects := [k8s_model:flowcontrol_v1beta2_subject()],
          resourceRules => [k8s_model:flowcontrol_v1beta2_resource_policy_rule()],
          nonResourceRules => [k8s_model:flowcontrol_v1beta2_non_resource_policy_rule()]}.

%% io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfiguration
%%
%% PriorityLevelConfiguration represents the configuration of a
%% priority level.
-type flowcontrol_v1beta2_priority_level_configuration() ::
        #{status => k8s_model:flowcontrol_v1beta2_priority_level_configuration_status(),
          spec => k8s_model:flowcontrol_v1beta2_priority_level_configuration_spec(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta(),
          kind => binary(),
          apiVersion => binary()}.
...
%% PriorityLevelConfigurationCondition defines the condition of
%% priority level.
-type flowcontrol_v1beta2_priority_level_configuration_condition() ::
        #{type => binary(),
          status => binary(),
          reason => binary(),
          message => binary(),
...
%% PriorityLevelConfigurationList is a list of
%% PriorityLevelConfiguration objects.
-type flowcontrol_v1beta2_priority_level_configuration_list() ::
        #{metadata => k8s_model:apimachinery_apis_meta_v1_list_meta(),
          kind => binary(),
          items := [k8s_model:flowcontrol_v1beta2_priority_level_configuration()],
          apiVersion => binary()}.
...
%% PriorityLevelConfigurationReference contains information that
%% points to the "request-priority" being used.
-type flowcontrol_v1beta2_priority_level_configuration_reference() ::
        #{name := binary()}.
...
%% PriorityLevelConfigurationSpec specifies the configuration of a
%% priority level.
-type flowcontrol_v1beta2_priority_level_configuration_spec() ::
        #{type := binary(),
          limited => k8s_model:flowcontrol_v1beta2_limited_priority_level_configuration()}.

%% io.k8s.api.flowcontrol.v1beta2.PriorityLevelConfigurationStatus
%%
%% PriorityLevelConfigurationStatus represents the current state of
%% a "request-priority".
-type flowcontrol_v1beta2_priority_level_configuration_status() ::
        #{conditions => [k8s_model:flowcontrol_v1beta2_priority_level_configuration_condition()]}.

%% io.k8s.api.flowcontrol.v1beta2.QueuingConfiguration
%%
%% QueuingConfiguration holds the configuration parameters for
%% queuing
-type flowcontrol_v1beta2_queuing_configuration() ::
        #{queues => integer(),
          queueLengthLimit => integer(),
          handSize => integer()}.
...
%% and least one member of namespaces matches the request's
%% namespace.
-type flowcontrol_v1beta2_resource_policy_rule() ::
        #{verbs := [binary()],
          resources := [binary()],
          namespaces => [binary()],
          clusterScope => boolean(),
...
%% ServiceAccountSubject holds detailed information for
%% service-account-kind subject.
-type flowcontrol_v1beta2_service_account_subject() ::
        #{namespace := binary(),
          name := binary()}.
...
%% request authentication system. There are three ways of matching
%% an originator; by user, group, or service account.
-type flowcontrol_v1beta2_subject() ::
        #{user => k8s_model:flowcontrol_v1beta2_user_subject(),
          serviceAccount => k8s_model:flowcontrol_v1beta2_service_account_subject(),
          kind := binary(),
          group => k8s_model:flowcontrol_v1beta2_group_subject()}.

%% io.k8s.api.flowcontrol.v1beta2.UserSubject
%%
%% UserSubject holds detailed information for user-kind subject.
-type flowcontrol_v1beta2_user_subject() ::
        #{name := binary()}.

%% io.cattle.helm.v1.HelmChart
-type io_cattle_helm_v1_helm_chart() ::
        #{status => json:value(),
          spec => json:value(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta_v2(),
          kind => binary(),
          apiVersion => binary()}.

%% io.cattle.helm.v1.HelmChartConfig
-type io_cattle_helm_v1_helm_chart_config() ::
        #{status => json:value(),
          spec => json:value(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta_v2(),
          kind => binary(),
...
-type io_cattle_helm_v1_helm_chart_config_list() ::
        json:value().

%% io.cattle.helm.v1.HelmChartList
%%
%% HelmChartList is a list of HelmChart
-type io_cattle_helm_v1_helm_chart_list() ::
        json:value().

%% io.cattle.k3s.v1.Addon
-type io_cattle_k3s_v1_addon() ::
        #{status => json:value(),
          spec => json:value(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta_v2(),
          kind => binary(),
...
-type io_cattle_k3s_v1_addon_list() ::
        json:value().

%% io.k8s.metrics.pkg.apis.metrics.v1beta1.ContainerMetrics
%%
%% ContainerMetrics sets resource usage metrics of a container.
-type io_k8s_metrics_pkg_apis_metrics_v1beta1_container_metrics() ::
        #{usage := #{_ := k8s_model:apimachinery_api_resource_quantity()},
          name := binary()}.

%% io.k8s.metrics.pkg.apis.metrics.v1beta1.NodeMetrics
%%
%% NodeMetrics sets resource usage metrics of a node.
-type io_k8s_metrics_pkg_apis_metrics_v1beta1_node_metrics() ::
        #{window := k8s_model:apimachinery_apis_meta_v1_duration(),
          usage := #{_ := k8s_model:apimachinery_api_resource_quantity()},
          timestamp := k8s_model:apimachinery_apis_meta_v1_time(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta(),
          kind => binary(),
          apiVersion => binary()}.
...
-type io_k8s_metrics_pkg_apis_metrics_v1beta1_node_metrics_list() ::
        #{metadata => k8s_model:apimachinery_apis_meta_v1_list_meta(),
          kind => binary(),
          items := [k8s_model:io_k8s_metrics_pkg_apis_metrics_v1beta1_node_metrics()],
          apiVersion => binary()}.

%% io.k8s.metrics.pkg.apis.metrics.v1beta1.PodMetrics
%%
%% PodMetrics sets resource usage metrics of a pod.
-type io_k8s_metrics_pkg_apis_metrics_v1beta1_pod_metrics() ::
        #{window := k8s_model:apimachinery_apis_meta_v1_duration(),
          timestamp := k8s_model:apimachinery_apis_meta_v1_time(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta(),
          kind => binary(),
          containers := [k8s_model:io_k8s_metrics_pkg_apis_metrics_v1beta1_container_metrics()],
          apiVersion => binary()}.

%% io.k8s.metrics.pkg.apis.metrics.v1beta1.PodMetricsList
%%
%% PodMetricsList is a list of PodMetrics.
-type io_k8s_metrics_pkg_apis_metrics_v1beta1_pod_metrics_list() ::
        #{metadata => k8s_model:apimachinery_apis_meta_v1_list_meta(),
          kind => binary(),
          items := [k8s_model:io_k8s_metrics_pkg_apis_metrics_v1beta1_pod_metrics()],
          apiVersion => binary()}.
...
-type networking_v1_ingress_class_parameters_reference() ::
        #{scope => binary(),
          namespace => binary(),
          name := binary(),
          kind := binary(),
...
-type networking_v1_ingress_class_spec() ::
        #{parameters => k8s_model:networking_v1_ingress_class_parameters_reference(),
          controller => binary()}.
...
-type policy_v1_pod_disruption_budget() ::
        #{status => k8s_model:policy_v1_pod_disruption_budget_status(),
          spec => k8s_model:policy_v1_pod_disruption_budget_spec(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta(),
          kind => binary(),
          apiVersion => binary()}.
...
-type policy_v1_pod_disruption_budget_list() ::
        #{metadata => k8s_model:apimachinery_apis_meta_v1_list_meta(),
          kind => binary(),
          items := [k8s_model:policy_v1_pod_disruption_budget()],
          apiVersion => binary()}.
...
%% PodDisruptionBudget.
-type policy_v1_pod_disruption_budget_spec() ::
        #{selector => k8s_model:apimachinery_apis_meta_v1_label_selector(),
...
%% system.
-type policy_v1_pod_disruption_budget_status() ::
        #{observedGeneration => integer(),
...
-type storage_v1beta1_csi_storage_capacity() ::
        #{storageClassName := binary(),
          nodeTopology => k8s_model:apimachinery_apis_meta_v1_label_selector(),
          metadata => k8s_model:apimachinery_apis_meta_v1_object_meta(),
          maximumVolumeSize => k8s_model:apimachinery_api_resource_quantity(),
          kind => binary(),
...
%% objects.
-type storage_v1beta1_csi_storage_capacity_list() ::
        #{metadata => k8s_model:apimachinery_apis_meta_v1_list_meta(),
          kind => binary(),
          items := [k8s_model:storage_v1beta1_csi_storage_capacity()],
          apiVersion => binary()}.

%% us.containo.traefik.v1alpha1.IngressRoute
%%
%% IngressRoute is an Ingress CRD specification.
-type us_containo_traefik_v1alpha1_ingress_route() ::
        #{spec := #{tls => #{store => #{namespace => binary(),
          name := binary()},
          secretName => binary(),
          options => #{namespace => binary(),
          name := binary()},
          domains => [#{sans => [binary()],
          main => binary()}],
          certResolver => binary()},
          routes := [#{services => [#{weight => integer(),
          strategy => binary(),
          sticky => #{cookie => #{secure => boolean(),
          sameSite => binary(),
          name => binary(),
          httpOnly => boolean()}},
          serversTransport => binary(),
          scheme => binary(),
          responseForwarding => #{flushInterval => binary()},
          port => json:value(),
...
-type us_containo_traefik_v1alpha1_ingress_route_list() ::
        json:value().

%% us.containo.traefik.v1alpha1.IngressRouteTCP
%%
%% IngressRouteTCP is an Ingress CRD specification.
-type us_containo_traefik_v1alpha1_ingress_route_tcp() ::
        #{spec := #{tls => #{store => #{namespace => binary(),
          name := binary()},
          secretName => binary(),
          passthrough => boolean(),
...
-type us_containo_traefik_v1alpha1_ingress_route_tcp_list() ::
        json:value().

%% us.containo.traefik.v1alpha1.IngressRouteUDP
%%
%% IngressRouteUDP is an Ingress CRD specification.
-type us_containo_traefik_v1alpha1_ingress_route_udp() ::
        #{spec := #{routes := [#{services => [#{weight => integer(),
          port := json:value(),
          namespace => binary(),
          name := binary()}]}],
          entryPoints => [binary()]},
...
-type us_containo_traefik_v1alpha1_ingress_route_udp_list() ::
        json:value().

%% us.containo.traefik.v1alpha1.Middleware
%%
%% Middleware is a specification for a Middleware resource.
-type us_containo_traefik_v1alpha1_middleware() ::
        #{spec := #{stripPrefixRegex => #{regex => [binary()]},
          stripPrefix => #{prefixes => [binary()],
          forceSlash => boolean()},
          retry => #{initialInterval => json:value(),
          attempts => integer()},
          replacePathRegex => #{replacement => binary(),
          regex => binary()},
          replacePath => #{path => binary()},
          redirectScheme => #{scheme => binary(),
          port => binary(),
          permanent => boolean()},
          redirectRegex => #{replacement => binary(),
          regex => binary(),
          permanent => boolean()},
          rateLimit => #{sourceCriterion => #{requestHost => boolean(),
          requestHeaderName => binary(),
          ipStrategy => #{excludedIPs => [binary()],
          depth => integer()}},
          period => json:value(),
          burst => integer(),
          average => integer()},
          plugin => #{_ := json:value()},
          passTLSClientCert => #{pem => boolean(),
          info => #{subject => #{serialNumber => boolean(),
          province => boolean(),
          ...
          country => boolean(),
          commonName => boolean()}}},
          ipWhiteList => #{sourceRange => [binary()],
          ipStrategy => #{excludedIPs => [binary()],
          depth => integer()}},
          inFlightReq => #{sourceCriterion => #{requestHost => boolean(),
          requestHeaderName => binary(),
          ipStrategy => #{excludedIPs => [binary()],
          depth => integer()}},
          amount => integer()},
          headers => #{stsSeconds => integer(),
          stsPreload => boolean(),
          stsIncludeSubdomains => boolean(),
          sslTemporaryRedirect => boolean(),
          sslRedirect => boolean(),
          sslProxyHeaders => #{_ := binary()},
          sslHost => binary(),
          sslForceHost => boolean(),
          referrerPolicy => binary(),
          publicKey => binary(),
          permissionsPolicy => binary(),
          isDevelopment => boolean(),
          hostsProxyHeaders => [binary()],
          frameDeny => boolean(),
          forceSTSHeader => boolean(),
          featurePolicy => binary(),
          customResponseHeaders => #{_ := binary()},
          customRequestHeaders => #{_ := binary()},
          customFrameOptionsValue => binary(),
          customBrowserXSSValue => binary(),
          contentTypeNosniff => boolean(),
          contentSecurityPolicy => binary(),
          browserXssFilter => boolean(),
          allowedHosts => [binary()],
          addVaryHeader => boolean(),
          accessControlMaxAge => integer(),
          accessControlExposeHeaders => [binary()],
          accessControlAllowOriginListRegex => [binary()],
          accessControlAllowOriginList => [binary()],
          accessControlAllowMethods => [binary()],
          accessControlAllowHeaders => [binary()],
          accessControlAllowCredentials => boolean()},
          forwardAuth => #{trustForwardHeader => boolean(),
          tls => #{insecureSkipVerify => boolean(),
          certSecret => binary(),
          caSecret => binary(),
          caOptional => boolean()},
          authResponseHeadersRegex => binary(),
          authResponseHeaders => [binary()],
          authRequestHeaders => [binary()],
          address => binary()},
          errors => #{status => [binary()],
          service => #{weight => integer(),
          strategy => binary(),
          sticky => #{cookie => #{secure => boolean(),
          sameSite => binary(),
          name => binary(),
          ...
          kind => binary()},
          query => binary()},
          digestAuth => #{secret => binary(),
          removeHeader => boolean(),
          realm => binary(),
          headerField => binary()},
          contentType => #{autoDetect => boolean()},
          compress => #{excludedContentTypes => [binary()]},
          circuitBreaker => #{expression => binary()},
          chain => #{middlewares => [#{namespace => binary(),
          name := binary()}]},
          buffering => #{retryExpression => binary(),
          memResponseBodyBytes => integer(),
          memRequestBodyBytes => integer(),
          maxResponseBodyBytes => integer(),
          maxRequestBodyBytes => integer()},
          basicAuth => #{secret => binary(),
          removeHeader => boolean(),
          realm => binary(),
          headerField => binary()},
          addPrefix => #{prefix => binary()}},
          metadata := k8s_model:apimachinery_apis_meta_v1_object_meta_v2(),
          kind => binary(),
          apiVersion => binary()}.
...
-type us_containo_traefik_v1alpha1_middleware_list() ::
        json:value().

%% us.containo.traefik.v1alpha1.MiddlewareTCP
%%
%% MiddlewareTCP is a specification for a MiddlewareTCP resource.
-type us_containo_traefik_v1alpha1_middleware_tcp() ::
        #{spec := #{ipWhiteList => #{sourceRange => [binary()]},
          inFlightConn => #{amount => integer()}},
          metadata := k8s_model:apimachinery_apis_meta_v1_object_meta_v2(),
          kind => binary(),
          apiVersion => binary()}.
...
-type us_containo_traefik_v1alpha1_middleware_tcp_list() ::
        json:value().
...
%% resource.
-type us_containo_traefik_v1alpha1_servers_transport() ::
        #{spec := #{serverName => binary(),
          rootCAsSecrets => [binary()],
          peerCertURI => binary(),
          maxIdleConnsPerHost => integer(),
          insecureSkipVerify => boolean(),
          forwardingTimeouts => #{responseHeaderTimeout => json:value(),
          idleConnTimeout => json:value(),
          dialTimeout => json:value()},
          'disableHTTP2' => boolean(),
          certificatesSecrets => [binary()]},
          metadata := k8s_model:apimachinery_apis_meta_v1_object_meta_v2(),
          kind => binary(),
          apiVersion => binary()}.
...
-type us_containo_traefik_v1alpha1_servers_transport_list() ::
        json:value().

%% us.containo.traefik.v1alpha1.TLSOption
%%
%% TLSOption is a specification for a TLSOption resource.
-type us_containo_traefik_v1alpha1_tls_option() ::
        #{spec := #{sniStrict => boolean(),
          preferServerCipherSuites => boolean(),
          minVersion => binary(),
          maxVersion => binary(),
          curvePreferences => [binary()],
          clientAuth => #{secretNames => [binary()],
          clientAuthType => binary()},
          cipherSuites => [binary()],
          alpnProtocols => [binary()]},
          metadata := k8s_model:apimachinery_apis_meta_v1_object_meta_v2(),
          kind => binary(),
          apiVersion => binary()}.
...
-type us_containo_traefik_v1alpha1_tls_option_list() ::
        json:value().

%% us.containo.traefik.v1alpha1.TLSStore
%%
%% TLSStore is a specification for a TLSStore resource.
-type us_containo_traefik_v1alpha1_tls_store() ::
        #{spec := #{defaultCertificate := #{secretName := binary()}},
          metadata := k8s_model:apimachinery_apis_meta_v1_object_meta_v2(),
          kind => binary(),
          apiVersion => binary()}.
...
-type us_containo_traefik_v1alpha1_tls_store_list() ::
        json:value().
...
-type us_containo_traefik_v1alpha1_traefik_service() ::
        #{spec := #{weighted => #{sticky => #{cookie => #{secure => boolean(),
          sameSite => binary(),
          name => binary(),
          httpOnly => boolean()}},
          services => [#{weight => integer(),
          strategy => binary(),
          sticky => #{cookie => #{secure => boolean(),
          sameSite => binary(),
          name => binary(),
...
-type us_containo_traefik_v1alpha1_traefik_service_list() ::
        json:value().
